...
__global__
void matricesAddKernel(Eigen::Matrix4f *A,
                        Eigen::Matrix4f *B,
                        Eigen::Matrix4f *C,
                        int n)
{
...
void matricesAdd(Eigen::Matrix4f *A,
                Eigen::Matrix4f *B,
                Eigen::Matrix4f *C,
                int n)
{
...
int main()
{
    ...
    Eigen::Matrix4f *input_matrix_1 = new Eigen::Matrix4f(Eigen::Matrix4f::Random());
    Eigen::Matrix4f *input_matrix_2 = new Eigen::Matrix4f(Eigen::Matrix4f::Random());
    Eigen::Matrix4f *output_matrix = new Eigen::Matrix4f(Eigen::Matrix4f::Zero());
